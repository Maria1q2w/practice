...
console.log('первое задание', events);


// вторая задача
gameEvents.delete(64);
console.log('второе задание', gameEvents);

// третья задача
console.log(`Событие в этом матче, появлялось в среднем, раз в ${90 / gameEvents.size} мин.`);
